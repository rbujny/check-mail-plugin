...
- TypeScript (strict mode) + Vite, CRXJS, Svelte 5 (003-yahoo-mail-support)
- N/A (Ephemeral processing only) (003-yahoo-mail-support)
...
## Recent Changes
- 003-yahoo-mail-support: Added TypeScript (strict mode) + Vite, CRXJS, Svelte 5
